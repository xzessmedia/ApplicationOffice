	...
	*/
	...
	public function GenerateApplication($token, $jsonfile, $contactname, $contactgender, $applicant_picture, $applicant_name,$applicant_jobtitle,$applicant_birthdate,$applicant_adress, $applicant_phone,$applicant_mailadress,$applicant_twitter,$applicant_facebook,$applicant_github,$applicant_xing, $introtext,$cvdata_lebenslauf, $cvdata_abschluesse, $portfoliodata,$aboutdata) {
		...
		$abschlusscontent = "";
						...
						$lebenslaufcontent .= '
							<tr>
							    <td>'.$cvdata['strStartDate'].'-'.$cvdata['strEndDate'].'</td>
	...
	*/
	...
	public function ShowInfoBox($title,$text)
	{
		$info = '<div class="container-fluid">
						<div class="jumbotron"><h1>'.$title.'</h1><p>'.$text.'</p><a class="btn btn-primary" role="button" href="javascript: history.back()">Zurück</a></div></div>';
	...
	*/
	public function GeneratePage($title,$content,$theme="cosmo") 
	{
		return('<!DOCTYPE html>
			...
			<body ng-app="ApplicationApp"><div class="container">'.$content.'</div><script src="js/angular/angular.min.js"></script><script src="js/bootstrap/js/bootstrap.min.js"></script><script src="js/jquery/jquery-3.1.0.js"></script></body></html>');
	}
